defmodule Faker.Address do
  ...
  @data ["North", "East", "West", "South", "New", "Lake", "Port"]
  ...
  @data ["town", "ton", "land", "ville", "berg", "burgh", "borough", "bury", "view", "port", "mouth", "stad", "furt", "chester", "mouth", "fort", "haven", "side", "shire"]
  @data_count Enum.count(@data)
  @doc """
  Return city suffix.
  """
