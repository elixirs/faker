defmodule Faker.Pizza do
  ...
  ## Examples
      ...
      iex> Faker.Pizza.pizzas(2)
      #=> ["30\" with Alfredo Sauce, Scallops, Lactose Free Cheese, and Cherry Tomatoes", "Family Deep Fried Pizza Double Dutch"]

      iex> Faker.Pizza.pizzas(2..3)
      #=> ["Medium Thai Chicken", "26\" with Eel and Salami", "Large with Squid, Duck, Meatballs, and Classic Tomato Sauce"]
  """
  ...
  ## Examples
      ...
      #=> "Personal Thin Crust Canadian"

      iex> Faker.Pizza.pizza(2)
      #=> "Small Mozzarella Bacon"
  """
  @spec pizza() :: String.t
  ...
  ## Examples
      ...
      #=> ["Banana", "Spinach", "Chicken"]

      iex> Faker.Pizza.toppings(4)
      #=> ["Bacon", "Pineapple", "Artichoke Hearts", "Broccoli"]
  """
