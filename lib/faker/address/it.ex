defmodule Faker.Address.It do
  ...
  sampler(:region, [
        ...
        "Toscana", "Trentino-Alto Adige/Südtirol", "Umbria", "Valle d'Aosta/Vallée d'Aoste", "Veneto"
      ])
  ...
  defp street_name(2), do: "#{street_prefix()} #{Faker.Name.It.first_name()} #{Faker.Name.It.last_name()}"
