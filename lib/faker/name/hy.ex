defmodule Faker.Name.Hy do
  ...
  ## Examples
      ...
      iex> Faker.Name.Hy.title_descriptor()
      "մարկետինգի"
      iex> Faker.Name.Hy.title_descriptor()
      "արտադրության"
      iex> Faker.Name.Hy.title_descriptor()
