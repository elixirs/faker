defmodule Faker.Name.Arm do
  ...
  ## Examples
      ...
      iex> Faker.Name.Arm.title_descriptor()
      "մարկետինգի"
      iex> Faker.Name.Arm.title_descriptor()
      "արտադրության"
      iex> Faker.Name.Arm.title_descriptor()
  ...
  ## Examples
      ...
      iex> Faker.Name.Arm.title_level()
      "ավագ"
      iex> Faker.Name.Arm.title_level()
      "առաջատար"
      iex> Faker.Name.Arm.title_level()
