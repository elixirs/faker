defmodule Faker.Name.Am do
  ...
  ## Examples
      ...
      iex> Faker.Name.Am.title_descriptor()
      "մարկետինգի"
      iex> Faker.Name.Am.title_descriptor()
      "արտադրության"
      iex> Faker.Name.Am.title_descriptor()
